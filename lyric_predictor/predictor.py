...
def predict_it(song_lyrics):
    """
    Takes in the user given song lyric and attempts to guess which artist
    wrote the lyric.

    Args:
        song_lyrics (_str_): _Given as the argument when calling this file._
    """
    ...
    print(f'My guess is: {prediction.title()}')
